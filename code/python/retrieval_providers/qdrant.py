...
class QdrantVectorClient(RetrievalClientBase):
    ...
    async def _collection_exists_internal(self, client: AsyncQdrantClient, collection_name: str) -> bool:
        """
        Check if a collection exists using get_collections() (compatible with all qdrant-client versions).
    ...
    async def collection_exists(self, collection_name: Optional[str] = None) -> bool:
        ...
        return await self._collection_exists_internal(client, collection_name)
    ...
    async def create_collection(self, collection_name: Optional[str] = None,
        ...
        try:
            ...
            if await self._collection_exists_internal(client, collection_name):
    ...
    async def delete_documents_by_site(
        ...
        if not await self._collection_exists_internal(client, collection_name):
            logger.warning(
